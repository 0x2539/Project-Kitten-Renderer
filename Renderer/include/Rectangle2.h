...
public:
	...
	bool contains(ShapeRectangle *rectangle);
};
...
bool Rectangle2::contains(ShapeRectangle *rectangle){
	return (this -> getX() <= rectangle -> getLocationX() && \
			this -> getY() <= rectangle -> getLocationY() && \
			this -> getX() + this -> getWidth() >= rectangle -> getLocationX() + rectangle -> getWidth() && \
			this -> getY() + this -> getHeight() >= rectangle -> getLocationY() + rectangle -> getHeight());
